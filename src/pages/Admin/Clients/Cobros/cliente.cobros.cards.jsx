...
const ClienteCobrosCards = ({setPage}) =>{
    return(
        ...
        <CreateClientCard Icon={IconCobroAbono} handleClick={()=>setPage(1)} title="Registrar Cobro Abono" text="Gestiona los abonos del cliente" />
        <CreateClientCard Icon={IconCobroProducto} handleClick={()=>setPage(2)} title="Registrar Cobro Producto" text="Registra los cobros de los productos" />
